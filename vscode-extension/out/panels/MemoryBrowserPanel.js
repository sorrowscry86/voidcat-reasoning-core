...
exports.MemoryBrowserPanel = void 0;
const fs = require("fs");
...
class MemoryBrowserPanel {
    static createOrShow(extensionUri, mcpClient) {
        ...
        const panel = vscode.window.createWebviewPanel('memoryBrowser', // Identifies the type of the webview. Used internally
    ...
    _addCategory(categoryName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this._mcpClient.addCategory(categoryName);
    ...
    _updateCategories() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const categories = yield this._mcpClient.listCategories();
    ...
    _updateWebview() {
        return __awaiter(this, arguments, void 0, function* (query = "", category = "") {
            try {
                const memories = yield this._mcpClient.listMemories(query, category);
                this._panel.webview.postMessage({
    ...
    _updateVisualization() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const stats = yield this._mcpClient.getMemoryStats();
                this._panel.webview.postMessage({
    ...
    _updateAnalytics() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const stats = yield this._mcpClient.getMemoryStats(); // Assuming getMemoryStats returns all relevant analytics
                this._panel.webview.postMessage({
...
exports.MemoryBrowserPanel = MemoryBrowserPanel;
//# sourceMappingURL=MemoryBrowserPanel.js.map