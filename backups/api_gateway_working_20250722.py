...
async def health_check() -> HealthResponse:
    ...
    if engine_ready:
        ...
        return HealthResponse(status="healthy", engine_ready=True, message=status_msg)
    else:
        status_msg = (
            "VoidCat Reasoning Core API is online but engine is not " "initialized."
        )
        return HealthResponse(status="degraded", engine_ready=False, message=status_msg)
