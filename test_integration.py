...
async def test_basic_functionality():
    ...
    try:
        ...
        print(
            f"   DeepSeek API: {'✅ Configured' if deepseek_configured else '❌ Not configured'}"
        )

        # Test a simple reasoning pipeline
        print("   🧠 Testing reasoning pipeline...")
        result = await enhanced._enhanced_reasoning_pipeline(
            "What is the capital of France?", model="deepseek-chat"
        )
        ...
        try:
            ...
            with open(claude_config_path, "r") as f:
                ...
                if (
                    ...
                    if (
                        "env" in voidcat_config
                        and "DEEPSEEK_API_KEY" in voidcat_config["env"]
                    ):
...
def test_system_requirements():
    ...
    required_modules = ["httpx", "numpy", "scikit-learn", "python-dotenv"]
