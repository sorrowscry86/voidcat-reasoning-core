...
class HybridVectorizer:
    ...
    def _cache_index(self, index: Dict[str, Any]) -> None:
        ...
        """
        cache_path = os.path.join(self.cache_dir, f"index_{self.index_hash}.pkl")
    ...
    def _load_cached_index(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Load vectors
            self.tfidf_vectors = self._decompress_vectors(index["tfidf_vectors"])
            self.semantic_vectors = self._decompress_vectors(index["semantic_vectors"])
